...
void P3DTimeslot::copy(const P3DTimeslot& other)
{
    ...
    this->wavelegnthIndex_var = other.wavelegnthIndex_var;
}
...
void P3DTimeslot::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->wavelegnthIndex_var);
}
...
void P3DTimeslot::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->wavelegnthIndex_var);
}
...
int P3DTimeslot::getWavelegnthIndex() const
{
    return wavelegnthIndex_var;
}

void P3DTimeslot::setWavelegnthIndex(int wavelegnthIndex)
{
    this->wavelegnthIndex_var = wavelegnthIndex;
}
...
int P3DTimeslotDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='w' && strcmp(fieldName, "wavelegnthIndex")==0) return base+2;
...
std::string P3DTimeslotDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getWavelegnthIndex());
        default: return "";
    }
}
...
bool P3DTimeslotDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setWavelegnthIndex(string2long(value)); return true;
