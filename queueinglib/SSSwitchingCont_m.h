...
#ifndef _QUEUEING_SSSWITCHINGCONT_M_H_
#define _QUEUEING_SSSWITCHINGCONT_M_H_
...
/**
 * Class generated from <tt>SSSwitchingCont.msg</tt> by opp_msgc.
 * <pre>
 * message SSSwitchingCont {
 *     bool switchingState;
 ...
 * </pre>
 */
class QUEUEING_API SSSwitchingCont : public ::cMessage
{
  protected:
  ...
  protected:
    ...
    bool operator==(const SSSwitchingCont&);

  public:
    SSSwitchingCont(const char *name=NULL, int kind=0);
    SSSwitchingCont(const SSSwitchingCont& other);
    virtual ~SSSwitchingCont();
    SSSwitchingCont& operator=(const SSSwitchingCont& other);
    virtual SSSwitchingCont *dup() const {return new SSSwitchingCont(*this);}
...
inline void doUnpacking(cCommBuffer *b, SSSwitchingCont& obj) {obj.parsimUnpack(b);}

}; // end namespace queueing

#endif // _QUEUEING_SSSWITCHINGCONT_M_H_
